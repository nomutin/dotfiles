...
[![pages](https://github.com/nomutin/dotfiles/actions/workflows/pages.yaml/badge.svg)](https://github.com/nomutin/dotfiles/actions/workflows/pages.yaml)

```shell
curl -fsSL https://nomutin.github.io/dotfiles/install.sh | bash
```

Settings for [bash](./dot_config/bashrc) (shell), [vim](./xdg_config/vim/vimrc) (text editor), [tmux](./xdg_config/tmux/tmux.conf) (multiplexer) and [mise](./xdg_config/mise/config.toml) (CLI manager).
